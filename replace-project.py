#!/usr/bin/env python3
"""Script to replace EXAMPLE_PROJECT in main.js with new dashboard"""
...
# Find the positions
start_marker = "const EXAMPLE_PROJECT = {"
end_marker = "const EMPTY_PROJECT = {};"
...
new_project = '''const EXAMPLE_PROJECT = {
...
# Replace the section
new_content = content[:start_pos] + new_project + "\n\n" + content[end_pos:]

# Write back
with open('main.js', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("✅ EXAMPLE_PROJECT successfully replaced with dashboard")
